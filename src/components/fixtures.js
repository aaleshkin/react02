...
export const articles = [
    {
        "id": "56c782f18990ecf954f6e027",
        "date": "2016-06-09T15:03:23.000Z",
        "title": "В Совете Европы вынесли решение по украинскому закону об образовании",
        "text": "Венецианская комиссия при Совете Европы рекомендовала продлить переходный период для исполнения статьи об образовании на языках национальных меньшинств после 2020 года. Об этом сообщило Министерство образования Украины. На сегодняшний день официальные выводы Венецианской комиссии не обнародованы. Ожидается, что оглашение выводов состоится 11 ноября. В украинском ведомстве также отметили, что комиссия рекомендовала произвести дальнейшую детализацию статьи о языке обучения. Венецианская комиссия является консультативным органом Совета Европы по конституционному праву.Ранее украинские власти направили туда закон об образовании для экспертизы.",
        "comments": [
            {
                "id": "qwerqwer",
                "user": "Gilliam Underwood",
